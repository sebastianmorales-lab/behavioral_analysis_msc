...
`{r}'''} fig|fig_2 Emociones frente a la categoria del rival`
...
`{r}'''}                              Chisq Df Pr(>Chisq)     pay_competitive.f         592.4132  3     <2e-16 *** rival.f                    89.1157  3     <2e-16 *** pay_competitive.f:rival.f   8.6712  9     0.4682     --- Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 '''`
...
![](images/paste-02CA931F.png) '''fig\|fig_4 Porcentaje de veces que los participantes eligieron el juego competitivo segun el nivel de recompensa ofrecido. Las barras de error representan el error estandar de la muestra. '''
